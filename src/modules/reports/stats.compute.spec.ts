...
function day(date: string, roomsSold: number, roomRevenueKobo: number, roomsAvailable = 20): DailyFlash {
  const f = {
    date, live: false, roomsTotal: 24, roomsOutOfOrder: 4, roomsAvailable, roomsSold, occupancyRate: 0, adrKobo: 0, revparKobo: 0,
    roomRevenueKobo, dayUseRevenueKobo: 1_000_000, otherRevenueKobo: 500_000, discountKobo: 200_000, taxKobo: 0, serviceChargeKobo: 0,
